...
# Login + signup + health + the SSO handshake are open; everything else under
# /api requires a valid session when REQUIRE_AUTH is on.
_AUTH_OPEN_PATHS = {
    "/api/account/login",
    "/api/account/register",  # self-service signup → admin approval queue
    "/api/health",
