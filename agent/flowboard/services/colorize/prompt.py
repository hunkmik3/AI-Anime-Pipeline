...
scenery that was not drawn. This does NOT apply to emphasis / flash / shout
balloons that held a word: those are TEXT BUBBLES, not background — remove them and
reconstruct the real character and scene behind, never keep a word-balloon as an
abstract light-burst or field.
...
_REMOVE_MANDATE = (
    ...
    "This INCLUDES emphasis / impact / 'shout' balloons and flash / burst balloons: a "
    "white or pale oval, round, cloud, jagged, spiky-edged, star-burst or radiating "
    "balloon that held a large stylised word (e.g. one emphasised word spread across "
    "it). Treat the WHOLE such balloon — its pale fill AND its spiky / radiating / "
    "star-burst outline — as text-and-bubble, remove ALL of it, and rebuild the "
    "character and background behind it. Do NOT mistake a word-carrying balloon for a "
    "drawn light-burst, sparkle, halo or impact effect and keep it: if a pale shape "
    "was carrying a word, it is a bubble, not scenery. "
    ...
    "bubble shapes and ZERO leftover white/pale bubble ovals, glows, halos or "
    "star-burst silhouettes anywhere. If in doubt about "
